...
function updateStatus(status){
    ...
    var boxTp = status[1].percent;
        if (boxHp <= 15){
            $('#boxHunger').css('background', '#FF0000');
        }  else if (boxHp <= 45){
        $('#boxHunger').css('background', '#ffcc00');
    }else if (boxHp >= 46){
        $('#boxHunger').css('background', '#ffffff');
    }
    
    if (boxTp <= 15){
        $('#boxThirst').css('background', '#FF0000');
    }  else if (boxTp <= 45){
    $('#boxThirst').css('background', '#ffcc00');
    }else if (boxTp >= 46){
    $('#boxThirst').css('background', '#ffffff');
    }
}
